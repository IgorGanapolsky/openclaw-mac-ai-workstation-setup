# Draft for openai/codex#21936

- OP: @naveen-malla
- Title: Chrome plugin missing from Codex Plugin Directory on macOS due to stale bundled marketplace cache
- Created: 2026-05-09T14:32:44Z
- URL: https://github.com/openai/codex/issues/21936
...
```
gh issue comment 21936 --repo openai/codex --body-file outbound/drafts/2026-05-14/openai-codex-21936.md
```
