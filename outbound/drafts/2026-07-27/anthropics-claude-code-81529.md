# Draft for anthropics/claude-code#81529

- OP: @dev-ignis
- Title: Auto-compaction stops firing entirely after v2.1.199 (regression from v2.1.92; still absent in v2.1.217)
- Created: 2026-07-27T03:30:54Z
- URL: https://github.com/anthropics/claude-code/issues/81529
...
```
gh issue comment 81529 --repo anthropics/claude-code --body-file outbound/drafts/2026-07-27/anthropics-claude-code-81529.md
```
