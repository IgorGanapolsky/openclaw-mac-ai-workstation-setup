# Draft for anthropics/claude-code#81531

- OP: @dev-ignis
- Title: Mid-session agent-loop freeze: session permanently stops producing output, no error (v2.1.199 and v2.1.217)
- Created: 2026-07-27T03:31:05Z
- URL: https://github.com/anthropics/claude-code/issues/81531
...
```
gh issue comment 81531 --repo anthropics/claude-code --body-file outbound/drafts/2026-07-27/anthropics-claude-code-81531.md
```
