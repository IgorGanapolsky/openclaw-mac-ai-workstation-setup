...
- [openai/codex#41356](https://github.com/openai/codex/issues/41356) — @Benjamai — Computer Use helper crashes on every click on macOS 27
...
- Already drafted in git history: 208 unique issue URLs

## Next step

Review each draft in `outbound/drafts/2026-08-28/`, write the personalized
