...
- [openai/codex#29350](https://github.com/openai/codex/issues/29350) — @thisisgpy — Computer Use plugin cause macos crush
...
- Already drafted in git history: 129 unique issue URLs

## Next step

Review each draft in `outbound/drafts/2026-06-22/`, write the personalized
